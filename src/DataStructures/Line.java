...
public class Line
{
     ...
     * @param absZ absolute z coordinate
     * @param dirX directional x coordinate
     * @param dirY directional y coordinate
     * @param dirZ directional z coordinate
     */
    public Line(float absX,
                float absY,
                float absZ,
                float dirX,
                float dirY,
     ...
     * @param cluster the given cluster ID
     */
